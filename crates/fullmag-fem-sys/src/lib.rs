...
pub struct fullmag_fem_plan_desc {
    ...
    pub ms_field: *const f64,       pub ms_field_len: u64,
    pub a_field: *const f64,        pub a_field_len: u64,
    pub alpha_field: *const f64,    pub alpha_field_len: u64,
    pub ku_field: *const f64,       pub ku_field_len: u64,
    pub ku2_field: *const f64,      pub ku2_field_len: u64,
    pub dind_field: *const f64,     pub dind_field_len: u64,
    pub dbulk_field: *const f64,    pub dbulk_field_len: u64,
    pub kc1_field: *const f64,      pub kc1_field_len: u64,
    pub kc2_field: *const f64,      pub kc2_field_len: u64,
    pub kc3_field: *const f64,      pub kc3_field_len: u64,
}
