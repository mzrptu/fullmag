// Suggested placement:
// apps/web/components/runs/control-room/useAnalyzeArtifacts.ts
...
export interface UseAnalyzeArtifactsState {
  loadState: LoadState;
...
export function useAnalyzeArtifacts(
  refreshNonce: number,
): UseAnalyzeArtifactsState {
