// File: fullmag_frontend_AnalyzeDiagnosticsPanel.tsx
// Placement target:
//   apps/web/components/runs/control-room/AnalyzeDiagnosticsPanel.tsx
    ...
    <div className="flex flex-col gap-3">
      ...
      {hasError && (
        <section className="rounded-xl border border-rose-500/25 bg-rose-500/10 p-3">
          <h3 className="text-[0.74rem] font-semibold text-rose-200">
            Backend Error
          </h3>
          <p className="mt-2 text-[0.7rem] leading-5 text-rose-100/90">
      ...
      {hasWarnings && (
        <section className="rounded-xl border border-amber-500/25 bg-amber-500/10 p-3">
          <h3 className="text-[0.74rem] font-semibold text-amber-200">
            Warnings
          </h3>
